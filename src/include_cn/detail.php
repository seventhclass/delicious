...
<div id="popup">
	...
	<div id="popup_main">
		...
		<div id="dish_text">
			<h1><?php echo $dish_info['dish_name_cn'];?></h1>
			<ul>
				<li>
					<div class="dt">菜单号</div>
					<div class="dd"><?php echo $dish_info['dish_no'];?></div>
				</li>
				<li>
					<div class="dt">分类:</div>
					<div class="dd"><?php echo $cate_info['cate_name_cn'];?></div>
				</li>
				<li>
					<div class="dt">辣:</div>
		...
		<div id="dish_desc">
			<h1><?php echo $dish_info['dish_desc_cn'];?></h1>
		</div>
