<header >
	...
	<ul id="languages">
		...
		<li><i id="lang_cn"></i><a href="./include_cn/header.php" id="chinese">中文</a></li>
		<li><i id="lang_en"></i><a href="#" id="english">English</a></li>
		<li><i id="lang_fr"></i><a href="#" id="french">Français</a></li>
	</ul>
  </nav>
</header>
