...
<html>
	<head>
		...
		<script type="text/javascript" src="./js/menupage_cn.js"></script>
	...
	<body>
		<?php
			include("./include_cn/home.php");
			include("./include_cn/menu.php");
			include("./include_cn/promotion.php");
			include("./include_cn/about.php");
			include("./include_cn/contact.php");
			include("./include_cn/header.php");
			include("./include_cn/footer.php");
			include("./include_cn/detail.php");
		?>
